...
Config.Item = "bigheadphones"
Config.Props = 'h4_prop_battle_headphones_dj'

Config.Language = {
    ['no_item'] = "You dont have headphones",
    ['target'] = "Put on/down headphones on a player",
    ['progress'] = "Putting headphonse on/down",
}